...
$("#form_hais").on("click", "#simpan_hais", function(event){
    ...
    $.post(url, {
      ...
      $('input:text[name=no_rawat]').val("{?=date('Y-m-d')?}");
...
$("#hais").on("click",".edit_hais", function(event){
  ...
  var DEKU            = $(this).attr("data-DARAH");
  var SPUTUM          = $(this).attr("data-URINE");
  var DARAH           = $(this).attr("data-SPUTUM");
